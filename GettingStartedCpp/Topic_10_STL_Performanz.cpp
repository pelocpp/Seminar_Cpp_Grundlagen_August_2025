...
namespace Algorithms {
    ...
    namespace Initialization_Array_Constant_Value {
        ...
        {
            // int                 numbers[10];  // Ist ein Array // C-Style
            // std::array<int, 10> numbers;      // Ist ein Array // C++-Style
            // Funktionell: Kein Unterschied
            // Warum std::array: Verbesserungen // Robustheit // OO

            // 2. Bemerkung:
            // Große Arrays können nicht am Stack liegen // Stackoverflow
        ...
        static auto test_array_constant_initialize_iterator_based()
        {
            ...
            for (std::array<double, ArraySize>::iterator it{ values.begin() }; it != values.end(); ++it) {
                *it = 123.0;
            }
        }
        ...
        static void belegeVor(double& elem) {
            elem = 123.0;
        }
