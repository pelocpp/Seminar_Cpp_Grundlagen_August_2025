...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        // Runtime // Properties ==> Objekten
        
        //var n;

        //let m;

        auto z = 123;   // Type Deduction // Typableitung

        int z0 = 123;

        auto z2 = 123.345f;   // Type Deduction // Typableitung
        ...
        auto d = 2.0f;               // float
        auto e = 'A';                // char
        auto f1 = "hi";              // char const*  // Vergangenheit: C
        auto f2 = std::string("hi"); // std::string
        auto g = true;               // bool
    ...
    static void test_03() {
      ...
      //  std::pair<int, std::string>& entry1 = *it;  // Why this line DOES NOT compile ???
        ...
        auto& entry2 = *it;  // Pro:  auto: Typableitung
    }
    ...
    static auto sum2(int f1, int f2)
    {
        return f1 + f2;
    }
    ...
    // Regelwerk für die Verknüpfung elem. Datentypen:
    ...
    void test_tue_was() {
        ...
        auto result1 = tueWas(true, (short) 123, 123ll);

        auto result2 = tueWas(true, 123.345f, 123.123);

        auto result3 = tueWasEx(true, (short)123, 123ll);

        auto result4 = tueWasEx(true, 123.345f, 123.123);
    ...
    {
        return message;  // Kann kein lokales Objekt sein // message ist ein globales Objekt
    }

    static std::string& getMessageZumDiskutieren() // 90%: Wie ist der Rückgabety definiert ???
    {
        std::string tmp("ABC");  // lokales Objekt !!! 
        return tmp;   // ist falsch !!!
    }

    void aufrufGetMessageZumDiskutieren()
    {
        std::string& result = getMessageZumDiskutieren(); 
    }
    ...
    void func()
    {
        MyContact myContact;
        // ...
        const std::string& first = myContact.getFirstName();

        // zB // unmittelbare Verwendung
        std::print("Firstname:", first);   // gut

        // wegspeichern / Ja - aber nicht die Referenz !!!
    ...
    static void test_06() {
        ...
        auto msg1 = getMessage();   // VON WELCHEM TYP IST msg1 ???
...
void main_auto()
{
    ...
    aufrufGetMessageZumDiskutieren();
